> **This is a modified build of ClamAV, maintained for SafeLayer AV.**
...
> signature verification and updating are upstream's code, unchanged.
> See [`safelayer/README.md`](safelayer/README.md). Licence: GPL-2.0, as upstream
> ([`COPYING.txt`](COPYING.txt)). For ClamAV itself go to
